...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Data Cleansing Service UK",
      "item": "https://www.lexalytic.com/services/data-cleansing"
    }
  ]
}
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: '760px' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(193,125,46,0.12)', border: '1px solid rgba(193,125,46,0.25)', borderRadius: '100px', padding: '6px 16px', marginBottom: '28px' }}>
              ...
              <span style={{ fontSize: '12px', color: 'var(--amber-text)', fontWeight: '500', letterSpacing: '0.5px' }}>Data Cleansing Service UK</span>
            </div>
      ...
      <section className="related-reading" style={{ background: 'var(--bg)', borderTop: '1px solid var(--border)', padding: 'clamp(40px, 6vw, 60px) 0' }}>
        <div style={{ maxWidth: 780, margin: '0 auto', padding: '0 20px' }}>
          ...
          <li style={{ marginBottom: 14 }}>
            <Link href="/blog/what-is-data-cleansing-uk" style={{ fontSize: 16, color: 'var(--ink)', textDecoration: 'none', fontWeight: 500 }}>
              What Is Data Cleansing - and Why Does Bad Data Cost UK Businesses So Much?
            </Link>
          </li>
          <li style={{ marginBottom: 14 }}>
            <Link href="/blog/data-cleansing-services-uk-businesses" style={{ fontSize: 16, color: 'var(--ink)', textDecoration: 'none', fontWeight: 500 }}>
              Data Cleansing Services for UK Businesses - What Is Involved and What It Costs
            </Link>
          </li>
          <li style={{ marginBottom: 14 }}>
            <Link href="/blog/data-driven-decision-making-uk-sme" style={{ fontSize: 16, color: 'var(--ink)', textDecoration: 'none', fontWeight: 500 }}>
              Data-Driven Decision Making for UK Small Businesses - Where to Start
            </Link>
          </li>
          </ul>
        </div>
