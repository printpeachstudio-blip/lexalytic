...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "VBA Developer UK",
      "item": "https://www.lexalytic.com/services/vba-development"
    }
  ]
}
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: '760px' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(193,125,46,0.12)', border: '1px solid rgba(193,125,46,0.25)', borderRadius: '100px', padding: '6px 16px', marginBottom: '28px' }}>
              ...
              <span style={{ fontSize: '12px', color: 'var(--amber-text)', fontWeight: '500', letterSpacing: '0.5px' }}>VBA Developer UK</span>
            </div>
      ...
      <section className="related-reading" style={{ background: 'var(--bg)', borderTop: '1px solid var(--border)', padding: 'clamp(40px, 6vw, 60px) 0' }}>
        <div style={{ maxWidth: 780, margin: '0 auto', padding: '0 20px' }}>
          ...
          <li style={{ marginBottom: 14 }}>
            <Link href="/blog/what-is-a-bespoke-website-uk" style={{ fontSize: 16, color: 'var(--ink)', textDecoration: 'none', fontWeight: 500 }}>
              What Is a Bespoke Website and Is It Worth It for UK Businesses?
            </Link>
          </li>
          <li style={{ marginBottom: 14 }}>
          ...
          <li style={{ marginBottom: 14 }}>
            <Link href="/blog/bespoke-website-vs-wordpress-uk" style={{ fontSize: 16, color: 'var(--ink)', textDecoration: 'none', fontWeight: 500 }}>
              Bespoke Website vs WordPress for UK Businesses in 2027 - The Honest Comparison
            </Link>
          </li>
          </ul>
        </div>
