...
const useCases = [
  ...
  { icon: '🧹', title: 'Large-Scale Data Cleaning', desc: 'Handle hundreds of thousands of records — standardising formats, removing duplicates, validating against rules, flagging anomalies — at a scale that Excel simply can\'t manage.' },
...
const faqs = [
  { q: 'When does Python make more sense than Excel or VBA?', a: 'Python is the right choice when you\'re working with large data volumes (Excel starts struggling above around 100,000 rows), when you need to connect to external APIs, when you want tasks to run automatically on a schedule without anyone opening a file, or when the logic is complex enough that VBA becomes hard to maintain. We\'ll give you an honest recommendation during the scoping call.' },
  { q: 'Do we need any technical setup to run Python scripts?', a: 'Usually not much. Many scripts run on a standard Windows PC or server you already have. For scheduled automation, we can configure Windows Task Scheduler or recommend a simple cloud option depending on your setup. We\'ll design the solution around what\'s practical for your team.' },
  { q: 'How long do Python automation projects take?', a: 'Typically 5–10 working days depending on complexity. Straightforward data processing scripts are at the faster end; full pipeline builds with multiple API integrations and error handling take longer. You\'ll get a clear timeline in your quote.' },
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: '760px' }}>
            ...
            <h1 style={{ color: 'var(--white)', marginBottom: '24px', lineHeight: '1.08', letterSpacing: '-0.03em' }}>
              When Excel isn't enough —<br /><em style={{ color: 'var(--amber)' }}>Python handles the rest.</em>
            </h1>
      ...
      <section style={{ padding: 'clamp(60px, 8vw, 100px) 0', background: 'var(--bg)' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '56px' }}>
            ...
            <h2>Python automation for data challenges Excel can't solve</h2>
