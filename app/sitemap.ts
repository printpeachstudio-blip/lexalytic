...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: 'https://www.lexalytic.com/blog/data-cleansing-services-uk-businesses', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://www.lexalytic.com/blog/hmo-management-software-uk', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://www.lexalytic.com/blog/xero-to-excel-automated-reports', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://www.lexalytic.com/blog/hmo-rent-tracking-uk', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://www.lexalytic.com/blog/small-business-kpi-dashboard-uk', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://www.lexalytic.com/blog/hmo-licence-compliance-uk', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://www.lexalytic.com/blog/ai-powered-proposal-generator-uk', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://www.lexalytic.com/blog/personal-trainer-client-management-uk', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://www.lexalytic.com/blog/bespoke-website-vs-wordpress-uk', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://www.lexalytic.com/blog/pt-business-tools-uk', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://www.lexalytic.com/blog/personal-trainer-invoicing-uk', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://www.lexalytic.com/blog/custom-crm-for-uk-small-business', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://www.lexalytic.com/blog/sports-club-membership-management-uk', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://www.lexalytic.com/blog/reduce-manual-data-entry-uk-business', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: 'https://www.lexalytic.com/services/client-portals', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
    { url: 'https://www.lexalytic.com/blog/client-portal-for-accountants-uk', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://www.lexalytic.com/blog/secure-client-portal-small-business-uk', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: 'https://www.lexalytic.com/tools/service-charge-check', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
    { url: 'https://www.lexalytic.com/blog/service-charge-18-month-rule', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
