...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "How to Replace Your Spreadsheet with a Proper Business Tool",
      "item": "https://www.lexalytic.com/blog/replace-spreadsheet-with-business-tool"
    }
  ]
}
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            We do this kind of work regularly. There is more on <Link href="/services/excel-automation" style={{ color: 'var(--amber)' }}>Excel automation work</Link>. Book a free 30-minute call. Tell us what the spreadsheet does and we will tell you whether a custom tool makes sense - and what it would cost to build it.
          </p>
