    ...
    <div style={background: 'var(--bg)', minHeight: '100vh'}>
      ...
      <article style={padding: 'clamp(40px, 6vw, 80px) 0'}>
        <div className="container" style={maxWidth: '780px'}>
          ...
          <p style={fontSize: '17px', color: 'var(--ink-2)', lineHeight: '1.85', marginBottom: '48px'}>Once the data is in Power Query, you transform it into the shape your report needs. Pivot tables, calculated columns, aggregations. The transformation steps run automatically every time you refresh. The report itself - the tables, charts, and layout in Excel - is built once and populates from the transformed data. Your weekly management report becomes a single click on Refresh.</p>
