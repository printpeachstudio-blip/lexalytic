...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "How to Get Your Xero Data Into Excel Automatically Without Exporting Every Week",
      "item": "https://www.lexalytic.com/blog/xero-to-excel-automated-reports"
    }
  ]
}
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center', marginTop: '64px' }}>
            ...
            Most of our <Link href="/services/excel-automation" style={{ color: 'var(--amber)' }}>Excel automation work</Link> starts with a spreadsheet somebody built years ago that nobody wants to touch. Book a free 30-minute call. Tell us what you need and we will tell you the best approach and what it would cost.
          </p>
