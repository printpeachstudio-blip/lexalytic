...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "How to Choose a Web Developer in the UK (Without Getting Burned)",
      "item": "https://www.lexalytic.com/blog/how-to-choose-a-web-developer-uk"
    }
  ]
}
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            That is how we approach <Link href="/services/website-development" style={{ color: 'var(--amber)' }}>website development</Link>. Book a free 30-minute call. Tell us what you need and we will tell you the best approach and what it would cost.
          </p>
