...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "How to See Your Business Performance at a Glance",
      "item": "https://www.lexalytic.com/blog/business-performance-at-a-glance-uk"
    }
  ]
}
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            Most of our <Link href="/services/power-bi" style={{ color: 'var(--amber)' }}>Power BI work</Link> starts with somebody rebuilding this by hand every month. Book a free 30-minute call. Tell us what you are trying to build and we will tell you the best approach - and what it would cost. We build exactly this sort of reporting.
          </p>
