...
const articleSchema = {
  ...
  "@type": "Article",
  "headline": "Data Cleansing Services for UK Businesses - What Is Involved and What It Costs",
  "description": "What data cleansing actually involves for UK businesses, what it costs, and how to know whether you need a service or can do it yourself.",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.lexalytic.com/blog/data-cleansing-services-uk-businesses"
  },
  "inLanguage": "en-GB",
  "wordCount": 1119,
  "articleSection": "Data Cleansing"
}
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Data Cleansing Services for UK Businesses - What Is Involved and What It Costs",
      "item": "https://www.lexalytic.com/blog/data-cleansing-services-uk-businesses"
    }
  ]
}
  ...
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <section style={{ paddingTop: '120px', paddingBottom: '60px', background: 'var(--bg-2)', borderBottom: '1px solid var(--border)' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          <div style={{ display: 'flex', gap: '12px', marginBottom: '20px', flexWrap: 'wrap' }}>
            <span style={{ fontSize: '12px', fontWeight: '500', color: 'var(--amber-text)', background: 'rgba(193,125,46,0.1)', padding: '4px 12px', borderRadius: '100px' }}>Data Cleansing</span>
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          <p style={{ fontSize: '18px', color: 'var(--ink-2)', lineHeight: '1.85', marginBottom: '48px' }}>Bad data is expensive in ways that are hard to see until something goes wrong. A marketing campaign sending to outdated email addresses. A financial report that does not reconcile because the underlying records are inconsistent. A customer service team working from records where the same customer appears three times with different spellings. Data cleansing is the process of fixing this.</p>
