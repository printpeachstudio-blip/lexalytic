...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "What Is an AI-Powered Business Tool - And Does Your Business Need One?",
      "item": "https://www.lexalytic.com/blog/what-is-an-ai-powered-business-tool-uk"
    }
  ]
}
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            We build tools with AI inside them rather than beside them. There is more on our <Link href="/services/ai-tools" style={{ color: 'var(--amber)' }}>AI tools work</Link> page. Book a free 30-minute call. Tell us what you are trying to build and we will tell you the best approach - and what it would cost.
          </p>
