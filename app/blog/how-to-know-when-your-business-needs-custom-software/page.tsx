...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "How to Know When Your Business Needs Custom Software Instead of a SaaS Tool",
      "item": "https://www.lexalytic.com/blog/how-to-know-when-your-business-needs-custom-software"
    }
  ]
}
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            If you want a number before you speak to anyone, the <Link href="/tools/build-estimator" style={{ color: 'var(--amber)' }}>free build cost estimator</Link> shows what each part of a build adds and why. Book a free 30-minute call. Tell us what you are trying to build and we will tell you the best approach - and what it would cost.
          </p>
