...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "How to See Which Jobs and Clients Are Actually Making You Money",
      "item": "https://www.lexalytic.com/blog/how-to-see-which-jobs-clients-are-profitable"
    }
  ]
}
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <section style={{ paddingTop: '120px', paddingBottom: '60px', background: 'var(--bg-2)', borderBottom: '1px solid var(--border)' }}>
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <h2 style={{ fontSize: 'clamp(1.4rem, 2.5vw, 1.9rem)', marginBottom: '20px', letterSpacing: '-0.02em' }}>Why job profitability is harder to see than it looks</h2>
          <p style={{ fontSize: '17px', color: 'var(--ink-2)', lineHeight: '1.85', marginBottom: '48px' }}>Revenue by client is visible in almost every accounting system. Cost by client is not - because costs are typically coded to expense categories, not to clients or jobs. Linking the two requires either a time recording system that allocates hours to jobs, a job costing module in your accounting software, or a manual allocation model in Excel. Most businesses have none of these and rely on gut feel to identify which clients are worth keeping and which are draining margin.</p>
          <h2 style={{ fontSize: 'clamp(1.4rem, 2.5vw, 1.9rem)', marginBottom: '20px', letterSpacing: '-0.02em' }}>Building a simple job profitability model</h2>
          <p style={{ fontSize: '17px', color: 'var(--ink-2)', lineHeight: '1.85', marginBottom: '48px' }}>The fastest approach for most service businesses is an Excel model that takes revenue by client from the accounting software export and sets it against an estimated cost allocation. Direct costs - materials, subcontractors, identifiable expenses - can be coded by job in most accounting systems with minimal setup. Labour cost allocation requires either time recording or an estimated percentage split. Even a rough model that allocates 70% of labour cost to the top 5 clients by revenue produces more useful information than having no view at all.</p>
          <h2 style={{ fontSize: 'clamp(1.4rem, 2.5vw, 1.9rem)', marginBottom: '20px', letterSpacing: '-0.02em' }}>What the data usually reveals</h2>
          <p style={{ fontSize: '17px', color: 'var(--ink-2)', lineHeight: '1.85', marginBottom: '48px' }}>When businesses first build job profitability visibility, the results typically challenge the assumptions that have built up over time. The largest client by revenue is rarely the most profitable. Long-standing clients who receive loyalty discounts often sit at margins 10-15 percentage points below newer clients. The jobs that feel straightforward are sometimes the most profitable; the demanding clients who require constant attention often generate the lowest net margin once management time is allocated. The data does not tell you to fire your biggest client - but it does give you the information to have a different conversation about pricing and scope.</p>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            There is more on the <Link href="/services/power-bi" style={{ color: 'var(--amber)' }}>Power BI work</Link> page about how we build this. Book a free 30-minute call and we will tell you exactly what automation would look like for your business - fixed price, no commitment.
          </p>
