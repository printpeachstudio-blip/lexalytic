      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            We build sites this way. There is more on <Link href="/services/website-development" style={{ color: 'var(--amber)' }}>website development</Link>. Book a free 30-minute call. Tell us what you are trying to build and we will tell you the best approach - and what it would cost.
          </p>
