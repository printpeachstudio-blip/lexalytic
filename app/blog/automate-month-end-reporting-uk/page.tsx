...
export const metadata: Metadata = {
  ...
  title: 'Automate Month-End Reporting: What to Fix First | Lexalytic',
  description: 'Month-end does not have to take a week. What UK finance teams automate first, what they leave alone, and the order that gets the biggest saving soonest without rebuilding everything at once.',
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "How to Automate Your Month-End Reporting (UK Guide 2026)",
      "item": "https://www.lexalytic.com/blog/automate-month-end-reporting-uk"
    }
  ]
}
      ...
      <section style={{ paddingTop: '120px', paddingBottom: '60px', background: 'var(--bg-2)', borderBottom: '1px solid var(--border)' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          <div style={{ display: 'flex', gap: '12px', marginBottom: '20px', flexWrap: 'wrap' }}>
            ...
            <span style={{ fontSize: '12px', fontWeight: '500', color: 'var(--amber-text)', background: 'rgba(193,125,46,0.1)', padding: '4px 12px', borderRadius: '100px' }}>Reporting</span>
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            Our <Link href="/tools/reporting-cost" style={{ color: 'var(--amber)' }}>free reporting cost calculator</Link> works out what this costs by role, using true employment cost rather than salary. Book a free 30-minute call. We will look at your current month-end process and tell you exactly what automation would look like - and what it would cost.
          </p>
