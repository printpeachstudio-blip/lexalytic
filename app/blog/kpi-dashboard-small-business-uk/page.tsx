...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "How to Build a KPI Dashboard for Your Small Business (UK Guide 2026)",
      "item": "https://www.lexalytic.com/blog/kpi-dashboard-small-business-uk"
    }
  ]
}
      ...
      <section style={{ paddingTop: '120px', paddingBottom: '60px', background: 'var(--bg-2)', borderBottom: '1px solid var(--border)' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          <div style={{ display: 'flex', gap: '12px', marginBottom: '20px', flexWrap: 'wrap' }}>
            ...
            <span style={{ fontSize: '12px', color: 'var(--ink-4)' }}>August 2026 · 13 min read</span>
          </div>
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            Most of our <Link href="/services/power-bi" style={{ color: 'var(--amber)' }}>Power BI work</Link> starts with somebody rebuilding this by hand every month. Book a free 30-minute call. Tell us what decisions you need to make and what data you have. We will tell you exactly what a dashboard would look like and what it would cost to build it.
          </p>
