...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Excel Automation for Construction Companies UK (2026 Guide)",
      "item": "https://www.lexalytic.com/blog/excel-automation-construction-companies-uk"
    }
  ]
}
      ...
      <section style={{ paddingTop: '120px', paddingBottom: '60px', background: 'var(--bg-2)', borderBottom: '1px solid var(--border)' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          <div style={{ display: 'flex', gap: '12px', marginBottom: '20px', flexWrap: 'wrap' }}>
            <span style={{ fontSize: '12px', fontWeight: '500', color: 'var(--amber-text)', background: 'rgba(193,125,46,0.1)', padding: '4px 12px', borderRadius: '100px' }}>Construction</span>
            ...
            <span style={{ fontSize: '12px', color: 'var(--ink-4)' }}>May 2026 · 7 min read</span>
          </div>
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            There is more on what we build for <Link href="/industries/construction" style={{ color: 'var(--amber)' }}>construction businesses</Link>. This is the sort of thing our <Link href="/services/excel-automation" style={{ color: 'var(--amber)' }}>Excel automation work</Link> handles. Book a free 30-minute call. Tell us how your job cost tracking currently works and we will tell you exactly what automation would look like for your business. We do this kind of work regularly.
          </p>
