...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "How to Stop Your Business Running on Gut Feeling",
      "item": "https://www.lexalytic.com/blog/stop-business-running-on-gut-feeling"
    }
  ]
}
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <section style={{ paddingTop: '120px', paddingBottom: '60px', background: 'var(--bg-2)', borderBottom: '1px solid var(--border)' }}>
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <h2 style={{ fontSize: 'clamp(1.4rem, 2.5vw, 1.9rem)', marginBottom: '20px', letterSpacing: '-0.02em' }}>What decisions actually require data versus judgement</h2>
          <p style={{ fontSize: '17px', color: 'var(--ink-2)', lineHeight: '1.85', marginBottom: '48px' }}>Not every business decision needs a dashboard. Judgement calls about people, culture, and strategy often resist quantification. But operational decisions - which clients to prioritise, whether to hire, how to price, which products or services to grow - are significantly better when made with data than without it. The goal is not to eliminate judgement but to inform it. A business owner who knows their actual margin by product line makes a different pricing decision than one who is estimating it.</p>
          <h2 style={{ fontSize: 'clamp(1.4rem, 2.5vw, 1.9rem)', marginBottom: '20px', letterSpacing: '-0.02em' }}>The three numbers most businesses do not know in real time</h2>
          <p style={{ fontSize: '17px', color: 'var(--ink-2)', lineHeight: '1.85', marginBottom: '48px' }}>Most small business owners can tell you their approximate revenue for the month. Very few can tell you their gross margin, their net margin after overhead allocation, and their cash position - all three, in real time, without asking someone to pull a report. These three numbers are the foundation of good operational decisions. When they are visible in real time, the quality of weekly decisions improves measurably. When they require a week of reconciliation to produce, decisions get made on outdated information or gut feel.</p>
          <h2 style={{ fontSize: 'clamp(1.4rem, 2.5vw, 1.9rem)', marginBottom: '20px', letterSpacing: '-0.02em' }}>Starting with one question</h2>
          <p style={{ fontSize: '17px', color: 'var(--ink-2)', lineHeight: '1.85', marginBottom: '48px' }}>The fastest path from gut feel to data-driven is picking one question that matters - the one you find yourself asking most often and least able to answer accurately. Is it which client generates the most profit? Which product has the best margin? How cash will look in six weeks? Start there. Build the smallest possible system that answers that one question accurately and automatically. The discipline of answering one question properly is worth more than a complex dashboard that nobody maintains. Once the first question is answered reliably, the second is easier - because the data infrastructure and the habit are already in place.</p>
