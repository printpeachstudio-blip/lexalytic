...
export const metadata: Metadata = {
  ...
  title: 'What Is Data Cleansing? What It Involves and What It Costs | Lexalytic',
  description: 'Deduplication, standardisation, validation and enrichment are four different jobs with four different prices, and most businesses need two of them. What each one actually does to your data, and what it costs for a UK business in 2026.',
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "What Is Data Cleansing? UK Guide to Fixing Bad Data (2026)",
      "item": "https://www.lexalytic.com/blog/what-is-data-cleansing-uk"
    }
  ]
}
      ...
      <section style={{ paddingTop: '120px', paddingBottom: '60px', background: 'var(--bg-2)', borderBottom: '1px solid var(--border)' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          <div style={{ display: 'flex', gap: '12px', marginBottom: '20px', flexWrap: 'wrap' }}>
            <span style={{ fontSize: '12px', fontWeight: '500', color: 'var(--amber-text)', background: 'rgba(193,125,46,0.1)', padding: '4px 12px', borderRadius: '100px' }}>Data Quality</span>
