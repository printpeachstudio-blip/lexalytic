...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "What Makes a Good Brief for a Developer? (UK Business Guide)",
      "item": "https://www.lexalytic.com/blog/what-makes-a-good-brief-for-a-developer"
    }
  ]
}
      ...
      <section style={{ paddingTop: '120px', paddingBottom: '60px', background: 'var(--bg-2)', borderBottom: '1px solid var(--border)' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          <div style={{ display: 'flex', gap: '12px', marginBottom: '20px', flexWrap: 'wrap' }}>
            <span style={{ fontSize: '12px', fontWeight: '500', color: 'var(--amber-text)', background: 'rgba(193,125,46,0.1)', padding: '4px 12px', borderRadius: '100px' }}>Working with Developers</span>
            <span style={{ fontSize: '12px', color: 'var(--ink-4)' }}>June 2026 · 5 min read</span>
          </div>
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            The <Link href="/tools/build-estimator" style={{ color: 'var(--amber)' }}>free build cost estimator</Link> produces a written brief you can take to any developer. Book a free 30-minute call. Tell us what you need and we will tell you the best approach and what it would cost.
          </p>
