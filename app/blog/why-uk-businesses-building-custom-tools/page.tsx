...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Why UK Small Businesses Are Building Custom Tools Instead of Buying Software",
      "item": "https://www.lexalytic.com/blog/why-uk-businesses-building-custom-tools"
    }
  ]
}
      ...
      <section style={{ paddingTop: '120px', paddingBottom: '60px', background: 'var(--bg-2)', borderBottom: '1px solid var(--border)' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          <div style={{ display: 'flex', gap: '12px', marginBottom: '20px', flexWrap: 'wrap' }}>
            ...
            <span style={{ fontSize: '12px', color: 'var(--ink-4)' }}>May 2026 · 8 min read</span>
          </div>
