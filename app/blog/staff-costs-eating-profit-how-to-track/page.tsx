...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Why Your Staff Costs Are Eating Your Profit - And How to Track It",
      "item": "https://www.lexalytic.com/blog/staff-costs-eating-profit-how-to-track"
    }
  ]
}
      ...
      <section style={{ paddingTop: '120px', paddingBottom: '60px', background: 'var(--bg-2)', borderBottom: '1px solid var(--border)' }}>
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 320px), 1fr))', gap: '16px', marginBottom: '56px' }}>
              ...
              <Link key={0} href="/blog/true-labour-cost-per-employee-uk" style={{ display: 'block', padding: '20px 24px', background: 'var(--bg-2)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', textDecoration: 'none' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            The <Link href="/tools/reporting-cost" style={{ color: 'var(--amber)' }}>free reporting cost calculator</Link> does this arithmetic and shows how quickly automating it would pay back. Book a free 30-minute call and we will tell you exactly what automation would look like for your business - fixed price, no commitment.
          </p>
