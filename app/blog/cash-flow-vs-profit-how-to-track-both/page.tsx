...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Why Cash Flow and Profit Are Different - And How to Track Both",
      "item": "https://www.lexalytic.com/blog/cash-flow-vs-profit-how-to-track-both"
    }
  ]
}
      ...
      <section style={{ paddingTop: '120px', paddingBottom: '60px', background: 'var(--bg-2)', borderBottom: '1px solid var(--border)' }}>
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            We build exactly this sort of reporting. There is more on the <Link href="/services/power-bi" style={{ color: 'var(--amber)' }}>Power BI work</Link> page. Book a free 30-minute call and we will tell you exactly what automation would look like for your business - fixed price, no commitment. We build exactly this sort of reporting.
          </p>
