    ...
    <div style={background: 'var(--bg)', minHeight: '100vh'}>
      ...
      <article style={padding: 'clamp(40px, 6vw, 80px) 0'}>
        <div className="container" style={maxWidth: '780px'}>
          ...
          <p style={fontSize: '17px', color: 'var(--ink-2)', lineHeight: '1.85', marginBottom: '48px'}>The actual problem in most grassroots clubs is not the software. It is the data. Incomplete contact details. Members registered in last year system who never migrated. Children registered under parent email addresses. Adults with three email addresses depending on which one they used at registration. No software solves bad data. The clubs that get the most from membership software are the ones that spend time cleaning their data before migrating, not after.</p>
