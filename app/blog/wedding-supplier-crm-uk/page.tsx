...
const articleSchema = {
  ...
  "@type": "Article",
  "headline": "Wedding Supplier CRM UK - What Small Businesses Actually Need to Track",
  "description": "Client management for UK wedding suppliers. What to track, what tools exist, and when a simple custom solution beats an off-the-shelf CRM.",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.lexalytic.com/blog/wedding-supplier-crm-uk"
  },
  "inLanguage": "en-GB",
  "wordCount": 1100,
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Wedding Supplier CRM UK - What Small Businesses Actually Need to Track",
      "item": "https://www.lexalytic.com/blog/wedding-supplier-crm-uk"
    }
  ]
}
