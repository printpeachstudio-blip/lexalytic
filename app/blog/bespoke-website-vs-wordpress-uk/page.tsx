    ...
    <div style={background: 'var(--bg)', minHeight: '100vh'}>
      ...
      <article style={padding: 'clamp(40px, 6vw, 80px) 0'}>
        <div className="container" style={maxWidth: '780px'}>
          ...
          <p style={fontSize: '17px', color: 'var(--ink-2)', lineHeight: '1.85', marginBottom: '48px'}>A bespoke website is built from scratch in a modern framework - Next.js, Astro, or similar - without a CMS layer. The design is original. The code is clean and purposeful. There are no plugins adding weight and security vulnerabilities. The result loads faster, scores higher on Core Web Vitals, and requires less ongoing maintenance. A bespoke site costs more upfront - typically £5,000 to £15,000 - but has lower ongoing costs because there is no hosting bill, no plugin licences, and no maintenance retainer if deployed on a modern serverless platform.</p>
          <div style={display: 'flex', gap: '20px', marginBottom: '48px', alignItems: 'flex-start'}>
            ...
            <div>
              ...
              <p style={fontSize: '17px', color: 'var(--ink-2)', lineHeight: '1.85', margin: 0}>Google uses Core Web Vitals as a direct ranking factor. A well-built bespoke site typically scores in the 90-100 range on PageSpeed Insights. A well-built WordPress site typically scores 60-80 with optimisation plugins. A poorly built WordPress site scores under 50. The difference between 60 and 95 translates directly into search ranking differences for competitive terms. If organic search traffic matters to your business, this is not an abstract technical difference.</p>
            </div>
          </div>
          <h2 style={fontSize: 'clamp(1.3rem, 2.5vw, 1.7rem)', marginBottom: '20px'}>When WordPress is the right choice</h2>
          <p style={fontSize: '17px', color: 'var(--ink-2)', lineHeight: '1.85', marginBottom: '48px'}>WordPress makes the most sense when you have a large content team that needs to publish without developer involvement, when you need a complex plugin integration that would require custom development in a bespoke build, or when budget is genuinely constrained and you need something professional live quickly. It also makes sense for e-commerce where WooCommerce has thousands of integrations.</p>
