...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "How to Start the New Year With Clean Business Data",
      "item": "https://www.lexalytic.com/blog/start-new-year-clean-business-data-uk"
    }
  ]
}
      ...
      <section style={{ paddingTop: '120px', paddingBottom: '60px', background: 'var(--bg-2)', borderBottom: '1px solid var(--border)' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          <div style={{ display: 'flex', gap: '12px', marginBottom: '20px', flexWrap: 'wrap' }}>
            ...
            <span style={{ fontSize: '12px', color: 'var(--ink-4)' }}>December 2026 · 5 min read</span>
          </div>
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            If you want to test a file before it goes anywhere, the <Link href="/tools/data-health-check" style={{ color: 'var(--amber)' }}>free data health check</Link> does it in your browser. Book a free 30-minute call. Tell us what you are trying to build and we will tell you the best approach - and what it would cost.
          </p>
