...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Power BI for Small Business UK - Is It Worth It?",
      "item": "https://www.lexalytic.com/blog/power-bi-small-business-uk-worth-it"
    }
  ]
}
      ...
      <section style={{ paddingTop: '120px', paddingBottom: '60px', background: 'var(--bg-2)', borderBottom: '1px solid var(--border)' }}>
        ...
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 320px), 1fr))', gap: '16px', marginBottom: '56px' }}>
              ...
              <Link key={0} href="/blog/power-bi-vs-excel" style={{ display: 'block', padding: '20px 24px', background: 'var(--bg-2)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', textDecoration: 'none' }}>
                <span style={{ fontSize: '11px', fontWeight: '500', color: 'var(--amber-text)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Power BI</span>
                <p style={{ fontSize: '15px', color: 'var(--ink)', marginTop: '8px', marginBottom: 0, lineHeight: '1.5', fontWeight: '500' }}>Power BI vs Excel: Which Should Your Business Use in 2026?</p>
              </Link>
              <Link key={1} href="/blog/power-bi-consultant-cost-uk" style={{ display: 'block', padding: '20px 24px', background: 'var(--bg-2)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', textDecoration: 'none' }}>
                <span style={{ fontSize: '11px', fontWeight: '500', color: 'var(--amber-text)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Power BI</span>
                <p style={{ fontSize: '15px', color: 'var(--ink)', marginTop: '8px', marginBottom: 0, lineHeight: '1.5', fontWeight: '500' }}>Power BI Consultant Cost UK: Hourly Rate & Day Rate Guide</p>
              </Link>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            We build exactly this sort of reporting. There is more on the <Link href="/services/power-bi" style={{ color: 'var(--amber)' }}>Power BI work</Link> page. Book a free 30-minute call and we will tell you exactly what automation would look like for your business - fixed price, no commitment.
          </p>
