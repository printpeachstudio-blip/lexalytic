...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "How to Tell If Your Business Is Actually Profitable (Not Just Busy)",
      "item": "https://www.lexalytic.com/blog/how-to-tell-if-your-business-is-profitable"
    }
  ]
}
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center' }}>
            ...
            If you want it built rather than described, that is our <Link href="/services/power-bi" style={{ color: 'var(--amber)' }}>Power BI work</Link>. Book a free 30-minute call. We will look at your current data setup and show you what a live profitability dashboard would look like for your business.
          </p>
