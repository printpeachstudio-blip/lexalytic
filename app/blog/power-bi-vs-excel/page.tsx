...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Power BI vs Excel: Which Should Your Business Use? (2026 Guide)",
      "item": "https://www.lexalytic.com/blog/power-bi-vs-excel"
    }
  ]
}

export default function BlogPost() {
  const structuredData = {"@context": "https://schema.org", "@type": "Article", "headline": "Power BI vs Excel: Which Should Your Business Use in 2026?", "description": "When to stick with Excel, when to move to Power BI, and what most UK businesses actually need.", "datePublished": "2026-04-15", "dateModified": "2026-04-15", "url": "https://www.lexalytic.com/blog/power-bi-vs-excel", "author": {"@type": "Person", "name": "Mihir Hindocha", "url": "https://www.lexalytic.com/about"}, "publisher": {"@type": "Organization", "name": "Lexalytic", "url": "https://www.lexalytic.com"}, "mainEntityOfPage": {"@type": "WebPage", "@id": "https://www.lexalytic.com/blog/power-bi-vs-excel"}}
      ...
      <section style={{ paddingTop: '120px', paddingBottom: '60px', background: 'var(--bg-2)', borderBottom: '1px solid var(--border)' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          <div style={{ display: 'flex', gap: '12px', marginBottom: '20px', flexWrap: 'wrap' }}>
            ...
            <span style={{ fontSize: '12px', fontWeight: '500', color: 'var(--amber-text)', background: 'rgba(193,125,46,0.1)', padding: '4px 12px', borderRadius: '100px' }}>Excel</span>
