...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "My Finance Team Is Spending Hours on Manual Reporting - How Do I Fix It?",
      "item": "https://www.lexalytic.com/blog/finance-team-manual-reporting-fix"
    }
  ]
}
          ...
          {[
            ...
            <div key={i} style={{ display: 'flex', gap: '24px', marginBottom: '36px', alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                {item.link && (
                  <Link href={item.link.href} style={{ fontSize: '14px', color: 'var(--amber-text)', textDecoration: 'none', fontWeight: '500' }}>
                    {item.link.text} →
                  </Link>
                )}
              </div>
