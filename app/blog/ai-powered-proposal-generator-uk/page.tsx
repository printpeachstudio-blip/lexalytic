...
const articleSchema = {
  ...
  "@type": "Article",
  "headline": "AI Proposal Generator for UK Businesses - How to Automate Your First Draft",
  "description": "How UK professional services firms are using AI to generate first draft proposals in minutes instead of hours.",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.lexalytic.com/blog/ai-powered-proposal-generator-uk"
  },
  "inLanguage": "en-GB",
  "wordCount": 1226,
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "AI Proposal Generator for UK Businesses - How to Automate Your First Draft",
      "item": "https://www.lexalytic.com/blog/ai-powered-proposal-generator-uk"
    }
  ]
}
      ...
      <section style={{ paddingTop: '120px', paddingBottom: '60px', background: 'var(--bg-2)', borderBottom: '1px solid var(--border)' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          <div style={{ display: 'flex', gap: '12px', marginBottom: '20px', flexWrap: 'wrap' }}>
            <span style={{ fontSize: '12px', fontWeight: '500', color: 'var(--amber-text)', background: 'rgba(193,125,46,0.1)', padding: '4px 12px', borderRadius: '100px' }}>AI Tools</span>
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center', marginTop: '64px' }}>
            ...
            We build tools with AI inside them rather than beside them. There is more on our <Link href="/services/ai-tools" style={{ color: 'var(--amber)' }}>AI tools work</Link> page. Book a free 30-minute call. Tell us what you need and we will tell you the best approach and what it would cost.
          </p>
