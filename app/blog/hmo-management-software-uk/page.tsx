        ...
        <div className="container" style={maxWidth: '780px'}>
          ...
          <div style={display: 'flex', gap: '20px', marginBottom: '48px', alignItems: 'flex-start'}>
            ...
            <div>
              ...
              <p style={fontSize: '17px', color: 'var(--ink-2)', lineHeight: '1.85', margin: 0}>Landlord Vision has an HMO module that tracks room-level occupancy and individual tenancies. The interface is functional rather than slick. It handles the financial side reasonably well - income tracking, expense allocation, tax year summaries. It costs around £8 per month for a small portfolio. For landlords who primarily want a financial record and are comfortable with a basic interface, it is adequate. For anything involving maintenance tracking or document management it is limited.</p>
            </div>
          </div>
          <h2 style={fontSize: 'clamp(1.3rem, 2.5vw, 1.7rem)', marginBottom: '20px'}>The spreadsheet reality</h2>
          <p style={fontSize: '17px', color: 'var(--ink-2)', lineHeight: '1.85', marginBottom: '48px'}>The honest truth is that most HMO landlords with fewer than 10 properties manage on a combination of spreadsheets, a basic tenancy agreement template, and a WhatsApp group for maintenance reports. This works until it does not - usually when a compliance issue arises, a deposit dispute goes to the tenancy deposit scheme, or HMRC asks for a detailed income breakdown. At that point the gaps in the record become expensive problems.</p>
