...
const articleSchema = {
  ...
  "@type": "Article",
  "headline": "HMO Licence Compliance for UK Landlords - What You Need to Track and When",
  "description": "HMO licence compliance in the UK involves more ongoing obligations than most landlords realise. Here is what needs tracking and how to avoid the costly surprises.",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.lexalytic.com/blog/hmo-licence-compliance-uk"
  },
  "inLanguage": "en-GB",
  "wordCount": 1121,
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "HMO Licence Compliance for UK Landlords - What You Need to Track and When",
      "item": "https://www.lexalytic.com/blog/hmo-licence-compliance-uk"
    }
  ]
}
      ...
      <article style={{ padding: 'clamp(40px, 6vw, 80px) 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '40px', background: 'var(--ink)', borderRadius: 'var(--radius-lg)', textAlign: 'center', marginTop: '64px' }}>
            ...
            There is more on what we build for <Link href="/industries/property" style={{ color: 'var(--amber)' }}>landlords and property businesses</Link>. Our <Link href="/tools/hmo-compliance-tracker" style={{ color: 'var(--amber)' }}>free HMO compliance tracker</Link> works out every certificate renewal date across a portfolio and exports them to your calendar. Book a free 30-minute call. Tell us what you need and we will tell you the best approach and what it would cost.
          </p>
