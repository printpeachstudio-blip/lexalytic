...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Do You Need an HMO Licence? Free UK Checker",
      "item": "https://www.lexalytic.com/tools/hmo-licence-checker"
    }
  ]
}
      ...
      <section className="related-reading" style={{ background: 'var(--bg)', borderTop: '1px solid var(--border)', padding: 'clamp(40px, 6vw, 60px) 0' }}>
        <div style={{ maxWidth: 780, margin: '0 auto', padding: '0 20px' }}>
          ...
          <li style={{ marginBottom: 14 }}>
            <Link href="/blog/hmo-management-software-uk" style={{ fontSize: 16, color: 'var(--ink)', textDecoration: 'none', fontWeight: 500 }}>
              HMO Management Software UK - What Actually Exists and What It Costs
            </Link>
          </li>
          </ul>
        </div>
