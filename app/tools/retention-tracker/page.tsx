      ...
      <section className="related-reading" style={{ background: 'var(--bg)', borderTop: '1px solid var(--border)', padding: 'clamp(40px, 6vw, 60px) 0' }}>
        <div style={{ maxWidth: 780, margin: '0 auto', padding: '0 20px' }}>
          ...
          <li style={{ marginBottom: 14 }}>
            <Link href="/blog/main-contractor-not-released-retention" style={{ fontSize: 16, color: 'var(--ink)', textDecoration: 'none', fontWeight: 500 }}>
              The Main Contractor Has Not Released Your Retention. What You Can Actually Do.
            </Link>
          </li>
          </ul>
        </div>
