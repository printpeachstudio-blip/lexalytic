...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Digital Studio Birmingham | Websites, Software & AI Tools | Lexalytic',
    description: 'Lexalytic is a UK digital studio serving Birmingham businesses. Bespoke websites, custom software, AI-powered tools and data systems. Fixed price.',
...
export default function BirminghamNOSPACEPage() {
  const structuredData = '{"@context":"https://schema.org","@type":"Service","name":"Digital Studio Birmingham","description":"UK digital studio serving Birmingham businesses.","url":"https://www.lexalytic.com/locations/birmingham","provider":{"@type":"LocalBusiness","name":"Lexalytic","url":"https://www.lexalytic.com","address":{"@type":"PostalAddress","addressLocality":"Bushey","addressRegion":"Hertfordshire","addressCountry":"GB"}},"areaServed":[{"@type":"City","name":"Birmingham"}],"serviceType":"Digital Studio"}'
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: '760px' }}>
            ...
            <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.4)', maxWidth: '620px', marginBottom: '40px', lineHeight: '1.75' }}>
              We work with businesses across the UK entirely remotely. Birmingham clients get direct access to the founder from first call to final handover — no account managers, no handoffs.
            </p>
          ...
          <div style={{ maxWidth: '720px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '20px' }}>
              ...
              <div style={{ padding: '24px', background: 'var(--bg-2)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)' }}>
                ...
                <p style={{ fontSize: '13px', color: 'var(--ink-3)', lineHeight: '1.6' }}>We work with Birmingham businesses entirely online. No commute costs, no office overhead — just the work.</p>
              </div>
            </div>
          </div>
        </div>
