...
export const metadata: Metadata = {
  alternates: { canonical: 'https://www.lexalytic.com/locations/bristol' },
  title: 'Digital Studio Bristol | Websites, Software & AI Tools | Lexalytic',
  description: 'Lexalytic is a UK digital studio serving Bristol businesses. Bespoke websites, custom software, AI-powered tools and data systems. Fixed price, delivered remotely.',
  keywords: 'digital studio Bristol, bespoke website developer Bristol, custom software Bristol, AI tools Bristol small business, website development Bristol SME, web developer Bristol UK',
  openGraph: {
    title: 'Digital Studio Bristol | Websites, Software & AI Tools | Lexalytic',
    description: 'Lexalytic is a UK digital studio serving Bristol businesses. Fixed price, delivered remotely.',
    url: 'https://www.lexalytic.com/locations/bristol',
    siteName: 'Lexalytic',
    locale: 'en_GB',
    type: 'website',
  },
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Digital Studio Bristol",
      "item": "https://www.lexalytic.com/locations/bristol"
    }
  ]
}
  ...
  return (
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: '760px' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(193,125,46,0.12)', border: '1px solid rgba(193,125,46,0.25)', borderRadius: '100px', padding: '6px 16px', marginBottom: '28px' }}>
              ...
              <span style={{ fontSize: '12px', color: 'var(--amber-text)', fontWeight: '500', letterSpacing: '0.5px' }}>Digital Studio serving Bristol businesses</span>
            </div>
            <h1 style={{ color: 'var(--white)', marginBottom: '24px', lineHeight: '1.08', letterSpacing: '-0.03em' }}>
              Digital studio for<br /><em style={{ color: 'var(--amber)' }}>Bristol businesses.</em>
            </h1>
            ...
            <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.4)', maxWidth: '620px', marginBottom: '40px', lineHeight: '1.75' }}>
              We work with Bristol businesses entirely remotely. Bristol clients get senior-level work and direct access to the founder - the same service we deliver to businesses anywhere in the UK.
            </p>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 3fr', gap: '48px', alignItems: 'start' }}>
            <div>
              ...
              <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)' }}>UK tech city outside London</div>
            </div>
            <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.5)', lineHeight: '1.8' }}>Bristol has one of the most vibrant technology and creative business communities in the UK outside London. The city has a particularly strong aerospace, technology, and professional services sector.</p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: 'clamp(60px, 8vw, 100px) 0', background: 'var(--bg-2)' }}>
        <div className="container">
          <span className="section-label">What we build for Bristol businesses</span>
          <h2 style={{ marginBottom: '16px', maxWidth: '560px' }}>Every service. Clear scope. Fixed price.</h2>
          <p style={{ fontSize: '15px', color: 'var(--ink-3)', marginBottom: '40px', maxWidth: '560px' }}>We work with Bristol businesses in technology, aerospace, creative, professional services, financial services.</p>
          ...
          <div style={{ maxWidth: '720px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '20px' }}>
              ...
              <div style={{ padding: '24px', background: 'var(--bg-2)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)' }}>
                ...
                <p style={{ fontSize: '13px', color: 'var(--ink-3)', lineHeight: '1.6' }}>We work with Bristol businesses entirely online. No commute costs, no office overhead - just the work, delivered to agreed timelines.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{ padding: 'clamp(60px, 8vw, 100px) 0', background: 'var(--bg-dark)' }}>
        <div className="container" style={{ textAlign: 'center', maxWidth: '640px', margin: '0 auto' }}>
          <h2 style={{ color: 'var(--white)', marginBottom: '20px' }}>Working with a Bristol business?<br /><em style={{ color: 'var(--amber)' }}>Let us build something properly.</em></h2>
