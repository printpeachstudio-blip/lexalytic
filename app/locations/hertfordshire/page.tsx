...
export const metadata: Metadata = {
  alternates: { canonical: 'https://www.lexalytic.com/locations/hertfordshire' },
  title: 'Digital Studio Hertfordshire | Websites, Software & AI Tools | Lexalytic',
  description: 'Lexalytic is a UK digital studio serving Hertfordshire businesses. Bespoke websites, custom software, AI-powered tools and data systems. Fixed price, delivered remotely.',
  keywords: 'digital studio Hertfordshire, bespoke website developer Hertfordshire, custom software Hertfordshire, AI tools Hertfordshire small business, website development Hertfordshire SME, web developer Hertfordshire UK',
  openGraph: {
    title: 'Digital Studio Hertfordshire | Websites, Software & AI Tools | Lexalytic',
    description: 'Lexalytic is a UK digital studio serving Hertfordshire businesses. Fixed price, delivered remotely.',
    url: 'https://www.lexalytic.com/locations/hertfordshire',
    siteName: 'Lexalytic',
    locale: 'en_GB',
    type: 'website',
  },
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Digital Studio Hertfordshire",
      "item": "https://www.lexalytic.com/locations/hertfordshire"
    }
  ]
}
  ...
  return (
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: '760px' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(193,125,46,0.12)', border: '1px solid rgba(193,125,46,0.25)', borderRadius: '100px', padding: '6px 16px', marginBottom: '28px' }}>
              ...
              <span style={{ fontSize: '12px', color: 'var(--amber-text)', fontWeight: '500', letterSpacing: '0.5px' }}>Digital Studio serving Hertfordshire businesses</span>
            </div>
            <h1 style={{ color: 'var(--white)', marginBottom: '24px', lineHeight: '1.08', letterSpacing: '-0.03em' }}>
              Digital studio for<br /><em style={{ color: 'var(--amber)' }}>Hertfordshire businesses.</em>
            </h1>
      ...
      <section style={{ padding: 'clamp(40px, 5vw, 60px) 0', background: 'var(--bg-dark-2)', borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 3fr', gap: '48px', alignItems: 'start' }}>
            <div>
              <div style={{ fontFamily: 'var(--serif)', fontSize: '2.5rem', color: 'var(--amber)', lineHeight: '1', marginBottom: '6px' }}>90K+</div>
              <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)' }}>Hertfordshire businesses</div>
            </div>
            <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.5)', lineHeight: '1.8' }}>Hertfordshire is home to over 90,000 businesses and has one of the highest business densities in the UK outside London. The county benefits from excellent transport links and proximity to London while maintaining lower operating costs.</p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: 'clamp(60px, 8vw, 100px) 0', background: 'var(--bg-2)' }}>
        <div className="container">
          <span className="section-label">What we build for Hertfordshire businesses</span>
          <h2 style={{ marginBottom: '16px', maxWidth: '560px' }}>Every service. Clear scope. Fixed price.</h2>
          <p style={{ fontSize: '15px', color: 'var(--ink-3)', marginBottom: '40px', maxWidth: '560px' }}>We work with Hertfordshire businesses in technology, professional services, life sciences, retail, financial services.</p>
          ...
          <div style={{ maxWidth: '720px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '20px' }}>
              ...
              <div style={{ padding: '24px', background: 'var(--bg-2)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)' }}>
                ...
                <p style={{ fontSize: '13px', color: 'var(--ink-3)', lineHeight: '1.6' }}>We work with Hertfordshire businesses entirely online. No commute costs, no office overhead - just the work, delivered to agreed timelines.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{ padding: 'clamp(60px, 8vw, 100px) 0', background: 'var(--bg-dark)' }}>
        <div className="container" style={{ textAlign: 'center', maxWidth: '640px', margin: '0 auto' }}>
          <h2 style={{ color: 'var(--white)', marginBottom: '20px' }}>Working with a Hertfordshire business?<br /><em style={{ color: 'var(--amber)' }}>Let us build something properly.</em></h2>
