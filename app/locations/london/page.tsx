...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Digital Studio London | Websites, Software & AI Tools | Lexalytic',
    description: 'Lexalytic is a UK digital studio serving London businesses. Fixed price, delivered remotely.',
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Digital Studio London",
      "item": "https://www.lexalytic.com/locations/london"
    }
  ]
}
  ...
  return (
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: '760px' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(193,125,46,0.12)', border: '1px solid rgba(193,125,46,0.25)', borderRadius: '100px', padding: '6px 16px', marginBottom: '28px' }}>
              ...
              <span style={{ fontSize: '12px', color: 'var(--amber-text)', fontWeight: '500', letterSpacing: '0.5px' }}>Digital Studio serving London businesses</span>
            </div>
      ...
      <section style={{ padding: 'clamp(40px, 5vw, 60px) 0', background: 'var(--bg-dark-2)', borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 3fr', gap: '48px', alignItems: 'start' }}>
            <div>
              <div style={{ fontFamily: 'var(--serif)', fontSize: '2.5rem', color: 'var(--amber)', lineHeight: '1', marginBottom: '6px' }}>1M+</div>
              <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)' }}>SMEs in Greater London</div>
            </div>
            <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.5)', lineHeight: '1.8' }}>London has the highest concentration of SMEs in the UK - over 1 million businesses, spanning finance, professional services, tech, creative, and retail. Competition for digital talent and agency services is intense, and prices reflect it.</p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: 'clamp(60px, 8vw, 100px) 0', background: 'var(--bg-2)' }}>
        <div className="container">
          <span className="section-label">What we build for London businesses</span>
          <h2 style={{ marginBottom: '16px', maxWidth: '560px' }}>Every service. Clear scope. Fixed price.</h2>
          <p style={{ fontSize: '15px', color: 'var(--ink-3)', marginBottom: '40px', maxWidth: '560px' }}>We work with London businesses in financial services, professional services, tech startups, creative agencies, retail.</p>
          ...
          <div style={{ maxWidth: '720px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '20px' }}>
              ...
              <div style={{ padding: '24px', background: 'var(--bg-2)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)' }}>
                ...
                <p style={{ fontSize: '13px', color: 'var(--ink-3)', lineHeight: '1.6' }}>We work with London businesses entirely online. No commute costs, no office overhead - just the work, delivered to agreed timelines.</p>
              </div>
            </div>
          </div>
        </div>
