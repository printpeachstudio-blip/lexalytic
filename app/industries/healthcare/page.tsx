...
export const metadata: Metadata = {
  alternates: { canonical: 'https://www.lexalytic.com/industries/healthcare' },
  title: 'Digital Studio for Healthcare UK | Lexalytic',
  description: 'Custom software and digital tools for UK healthcare businesses. Staff scheduling tools, patient management systems, reporting dashboards and more. Fixed price.',
  keywords: 'custom software healthcare UK, staff rota app healthcare UK, locum management tool UK, patient management system UK, healthcare dashboard UK, bespoke healthcare software',
  openGraph: {
    title: 'Digital Studio for Healthcare UK | Lexalytic',
    description: 'Custom software and digital tools for UK healthcare businesses. Staff scheduling tools, patient management systems, reporting dashboards and more. Fixed price.',
    url: 'https://www.lexalytic.com/industries/healthcare',
    siteName: 'Lexalytic',
    locale: 'en_GB',
    type: 'website',
  },
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: '760px' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(193,125,46,0.12)', border: '1px solid rgba(193,125,46,0.25)', borderRadius: '100px', padding: '6px 16px', marginBottom: '28px' }}>
              ...
              <span style={{ fontSize: '12px', color: 'var(--amber)', fontWeight: '500', letterSpacing: '0.5px' }}>Digital Studio for Healthcare</span>
            </div>
      ...
      <section style={{ padding: 'clamp(60px, 8vw, 100px) 0', background: 'var(--bg-2)' }}>
        <div className="container">
          <span className="section-label">What we build for Healthcare businesses</span>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ padding: '24px', background: 'var(--bg)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)' }}>
              ...
              <p style={{ fontSize: '13px', color: 'var(--ink-3)', lineHeight: '1.6' }}>Custom locum management tools that track shifts, calculate pay automatically, flag payment due dates, and maintain a complete compliance record for every locum.</p>
            </div>
            <div style={{ padding: '24px', background: 'var(--bg)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)' }}>
            ...
            <div style={{ padding: '24px', background: 'var(--bg)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)' }}>
              ...
              <p style={{ fontSize: '13px', color: 'var(--ink-3)', lineHeight: '1.6' }}>Fast, professional websites for healthcare businesses. CQC compliance, service pages, and patient-facing content built to rank on Google.</p>
            </div>
