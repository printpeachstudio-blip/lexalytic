...
export const metadata: Metadata = {
  alternates: { canonical: 'https://www.lexalytic.com/industries/construction' },
  title: 'Digital Studio for Construction UK | Lexalytic',
  description: 'Custom software, websites and data tools for UK construction companies. Job cost tracking, project management tools, site reporting dashboards and more. Fixed price.',
  keywords: 'custom software construction UK, job cost tracker construction UK, website developer construction company UK, Excel automation construction UK, project management tool construction',
  openGraph: {
    title: 'Digital Studio for Construction UK | Lexalytic',
    description: 'Custom software, websites and data tools for UK construction companies. Job cost tracking, project management tools, site reporting dashboards and more. Fixed price.',
    url: 'https://www.lexalytic.com/industries/construction',
    siteName: 'Lexalytic',
    locale: 'en_GB',
    type: 'website',
  },
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: '760px' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(193,125,46,0.12)', border: '1px solid rgba(193,125,46,0.25)', borderRadius: '100px', padding: '6px 16px', marginBottom: '28px' }}>
              ...
              <span style={{ fontSize: '12px', color: 'var(--amber)', fontWeight: '500', letterSpacing: '0.5px' }}>Digital Studio for Construction</span>
            </div>
            <h1 style={{ color: 'var(--white)', marginBottom: '24px', lineHeight: '1.08', letterSpacing: '-0.03em' }}>Digital tools built for UK construction businesses.</h1>
            <p style={{ fontSize: 'clamp(16px, 2vw, 19px)', color: 'rgba(255,255,255,0.55)', maxWidth: '620px', marginBottom: '24px', fontWeight: '300', lineHeight: '1.75' }}>SUBDigital tools built for UK construction businesses.</p>
            <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.4)', maxWidth: '620px', marginBottom: '40px', lineHeight: '1.75' }}>Construction businesses have specific data challenges — job costing, subcontractor management, CIS calculations, project profitability. We have built tools for construction companies and understand the sector.</p>
      ...
      <section style={{ padding: 'clamp(60px, 8vw, 100px) 0', background: 'var(--bg-2)' }}>
        <div className="container">
          <span className="section-label">What we build for Construction businesses</span>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <h3 style={{ fontSize: '15px', fontWeight: '600', marginBottom: '8px', color: 'var(--ink)' }}>Job cost tracking tools</h3>
              <p style={{ fontSize: '13px', color: 'var(--ink-3)', lineHeight: '1.6' }}>Custom job cost trackers that pull from your accounting software and show margin by project in real time — so you know which jobs are profitable before they finish.</p>
            </div>
            <div style={{ padding: '24px', background: 'var(--bg)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)' }}>
              <h3 style={{ fontSize: '15px', fontWeight: '600', marginBottom: '8px', color: 'var(--ink)' }}>Project management dashboards</h3>
              <p style={{ fontSize: '13px', color: 'var(--ink-3)', lineHeight: '1.6' }}>Live dashboards showing every active project — costs, milestones, variations, and forecast margin — updated automatically from your existing systems.</p>
            </div>
            <div style={{ padding: '24px', background: 'var(--bg)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)' }}>
              <h3 style={{ fontSize: '15px', fontWeight: '600', marginBottom: '8px', color: 'var(--ink)' }}>CIS and payroll automation</h3>
              <p style={{ fontSize: '13px', color: 'var(--ink-3)', lineHeight: '1.6' }}>Automated CIS deduction calculations, subcontractor payment tracking, and payroll reporting built in Excel or as a custom web tool.</p>
            </div>
            <div style={{ padding: '24px', background: 'var(--bg)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)' }}>
              <h3 style={{ fontSize: '15px', fontWeight: '600', marginBottom: '8px', color: 'var(--ink)' }}>Custom CRM for construction</h3>
              <p style={{ fontSize: '13px', color: 'var(--ink-3)', lineHeight: '1.6' }}>A CRM built around the construction sales process — quotes, tenders, follow-ups, won and lost jobs — not adapted from a generic sales tool.</p>
            </div>
            <div style={{ padding: '24px', background: 'var(--bg)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)' }}>
              <h3 style={{ fontSize: '15px', fontWeight: '600', marginBottom: '8px', color: 'var(--ink)' }}>Bespoke construction websites</h3>
              <p style={{ fontSize: '13px', color: 'var(--ink-3)', lineHeight: '1.6' }}>Fast, SEO-optimised websites for construction companies. Project portfolios, accreditation pages, and lead generation built in Next.js.</p>
            </div>
          ...
          <div style={{ maxWidth: '720px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '20px' }}>
              ...
              <div style={{ padding: '24px', background: 'var(--bg-2)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)' }}>
                ...
                <p style={{ fontSize: '13px', color: 'var(--ink-3)', lineHeight: '1.6' }}>We have built tools for Construction businesses and understand the specific operational challenges of the sector — not just the technology.</p>
              </div>
              <div style={{ padding: '24px', background: 'var(--bg-2)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)' }}>
